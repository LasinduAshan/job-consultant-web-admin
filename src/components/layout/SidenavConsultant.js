...
function SidenavConsultant({color}) {
    ...
    return (
        <>
            ...
            <Menu theme="light" mode="inline">
                <Menu.Item key="1">
                    <NavLink exact to="/consultant/dashboard">
            <span
                className="icon"
                style={{
            ...
            >
              {dashboard}
                ...
                <Menu.Item key="2">
                    <NavLink to="/consultant/appointments">
            <span
                className="icon"
                style={{
            ...
            >
              {tables}
                ...
                {/*<Menu.Item key="3">
            <NavLink to="/consultant/consultants">
            <span
                className="icon"
                style={{
            ...
            >
              ...
              <span className="label">Consultants</span>
            </NavLink>
          </Menu.Item>*/}
...
export default SidenavConsultant;
